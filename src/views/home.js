  ...
  mainContainer.innerHTML = `
    ...
    <section id="section-videogames" class="mb-20 pt-10">
      <div class="flex justify-between items-end border-b border-card-color mb-6 pb-2">
        ...
        <button class="text-xs font-ui text-(--green-neon) hover:text-white transition-colors border border-green-neon px-3 py-1 bg-green-neon/10 hover:bg-green-neon/30">+ Añadir</button>
      </div>
